...
export class ProductsService {
  ...
  },
  {
    ...
    "price": 160,
    "desc": "Нормера - засіб профілактично-гігієнічний, має антиоксидантну, імуномоделюючу, в'яжучу, протизапальну, ранозагоювальну, регенеруючу, бактерицидну, білевгамовуючу, спазмолітичну, кровоспинну.",
  ...
  },
  {
    ...
    "price": 240,
    "desc": "Розчин хлоргексидину біглюконату чинить швидку та виражену дію на грампозитивні та грамнегативні бактерії, дріжджі та дерматофіти.",
  ...
  },
  {
    ...
    "price": 240,
    "desc": "Фізорм — засіб профілактично-гігієнічний, має антибактеріальну, протигрибкову, протизапальну, імуностимулюючу, регенеративну, анестезуючу, протипухлинну, адаптогенну дії.",
